  ...
  tabPanel("Población vulnerable",
              fluidRow(
                column(5,
                       ...
                       conditionalPanel(
                         condition = "input.ayuda_pobreza_ingresos != 0",
                       ...
                       conditionalPanel(
                         condition = "input.ayuda_pobreza_multi_casen != 0",
                       ...
                       conditionalPanel(
                         condition = "input.ayuda_hacinamiento_casen != 0",
                       ...
                       conditionalPanel(
                         condition = "input.ayuda_servicios_casen != 0",
                       ...
                       conditionalPanel(
                         condition = "input.ayuda_calidad != 0",
                       ...
                       conditionalPanel(
                         condition = "input.ayuda_malnutricion_casen != 0",
                       ...
                       conditionalPanel(
                         condition = "input.ayuda_comida != 0",
                       ...
                       conditionalPanel(
                         condition = "input.ayuda_comida_insuficiencia != 0",
